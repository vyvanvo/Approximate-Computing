...
HD_PWD='C:/Users/yvvan/Documents/Research/Approximate Computing/MAC_unit/MAC_unit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MAC_unit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MAC_unit.tcl

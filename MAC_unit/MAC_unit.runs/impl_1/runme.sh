...
HD_PWD='C:/Users/yvvan/Documents/Research/Approximate Computing/MAC_unit/MAC_unit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MAC_unit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MAC_unit.tcl -notrace

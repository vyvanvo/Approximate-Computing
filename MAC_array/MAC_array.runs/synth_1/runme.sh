...
HD_PWD='C:/Users/yvvan/Documents/Research/Approximate Computing/MAC_array/MAC_array.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MAC_array.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MAC_array.tcl

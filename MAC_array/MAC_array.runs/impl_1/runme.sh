...
HD_PWD='C:/Users/yvvan/Documents/Research/Approximate Computing/MAC_array/MAC_array.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MAC_array.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MAC_array.tcl -notrace

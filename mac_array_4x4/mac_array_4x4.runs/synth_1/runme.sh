...
HD_PWD='C:/Users/yvvan/Documents/Research/Approximate Computing/mac_array_4x4/mac_array_4x4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mac_array_4x4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mac_array_4x4.tcl
